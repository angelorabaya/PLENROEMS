...
const DailyCollection = () => {
        ...
        () => [
            ...
            columnHelper.accessor('aop_ordate', {
                ...
                cell: (info) => {
                    ...
                    return dateVal
                        ? new Date(dateVal).toLocaleDateString('en-US', { timeZone: 'Asia/Manila' })
                        : '';
                },
            }),
    ...
    const rangeEnd =
        filteredRowCount === 0 ? 0 : Math.min((pageIndex + 1) * pageSize, filteredRowCount);

    return (
        <div
            className={`min-h-full p-8 ${isDark ? 'bg-gray-950 text-white' : 'bg-gray-50 text-gray-900'}`}
        >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-3 bg-white dark:bg-gray-800 p-2 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <label className="text-sm font-medium whitespace-nowrap px-2 text-gray-700 dark:text-gray-300">
                                Date:
                            </label>
                            <input
                                type="date"
                        ...
                        <button
                            onClick={fetchData}
                            disabled={loading}
                            className={`p-2.5 rounded-lg shadow-sm border transition-all duration-200 ${
                                isDark
                    ...
                    >
                        ...
                        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4">
                            <div className="relative w-full md:w-64">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-10 pr-3 py-2 border rounded-lg leading-5 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-violet-500 sm:text-sm transition duration-150 ease-in-out ${
                                        isDark
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div
                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg ${isDark ? 'bg-blue-900/20 text-blue-300' : 'bg-blue-50 text-blue-700'}`}
                                >
                                ...
                                <div
                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg ${isDark ? 'bg-violet-900/20 text-violet-300' : 'bg-violet-50 text-violet-700'}`}
                                >
                        ...
                        <div className="overflow-x-visible">
                            <table className="w-max min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody
                                    className={`divide-y divide-gray-200 dark:divide-gray-700 ${isDark ? 'bg-gray-800' : 'bg-white'}`}
                                >
                                    {loading ? (
                                        <tr>
                                            <td
