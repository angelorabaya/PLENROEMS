...
const AssessmentPreview = () => {
    // Assuming 'assessment' is the permission for this feature
    ...
    const renderPanel = (copyIndex = 0) => (
        <div
            key={copyIndex}
            className={`assessment-print-panel${copyIndex === 1 ? ' print-only' : ''}`}
        >
            ...
            <div className="assessment-print-body">
                ...
                <div className="remarks-row">
                    ...
                    <span className="value">{previewData?.remarks || 'N/A'}</span>
                </div>
    ...
    return (
        ...
        >
            ...
            <div
                className="print-panels"
                style={{
                    '--panel-gap': (() => {
                        const rowCount = preparedItems.length;
                        const spaces = rowCount >= 4 ? 2 : rowCount === 3 ? 3 : 4;
                        const spaceSize = 16; // px per blank line
                        return `${spaces * spaceSize}px`;
                    })(),
                }}
            >
                {[0, 1].map((idx) => renderPanel(idx))}
            </div>
        </div>
    );
};
