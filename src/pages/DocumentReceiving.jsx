...
const DocumentReceiving = () => {
    ...
    const fetchRecords = async () => {
        ...
        setError('');
        try {
            const data = await api.getDocumentReceiving();
            setRecords(data || []);
        } catch (err) {
        ...
        <div className="transactions-page">
            <div className="page-header">
                <div className="page-title-section">
                    ...
                    />
                    <h2 className="page-title">Document Receiving</h2>
                </div>
            ...
            <div className="table-container">
                {loading ? (
                        ...
                        <tbody>
                            {records.map((record) => (
                                <tr key={record.dms_ctrlno}>
                                    ...
                                    <td>
                                        <span className="cell-text" title={record.dms_source}>
                                            {record.dms_source || ''}
                                        </span>
                                    </td>
                                    <td>
                    ...
                    <div style={{ padding: '24px', textAlign: 'center', color: '#999' }}>
                        <p>No document receiving records found for today.</p>
                    </div>
                )}
            </div>
...
export default DocumentReceiving;
